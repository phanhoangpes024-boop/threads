    ...
    <>
      ...
      <nav className={styles.desktopNav}>
        ...
        <div className={styles.navItems}>
          <a href="/" className={`${styles.navItem} ${isActive('/') && !pathname?.startsWith('/search') && !pathname?.startsWith('/profile') && !pathname?.startsWith('/activity') ? styles.active : ''}`}>
          ...
          <a href="/search" className={`${styles.navItem} ${isActive('/search') ? styles.active : ''}`}>
            <svg viewBox="0 0 24 24">
