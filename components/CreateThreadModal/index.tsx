      ...
      <div className={styles.container} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.inputSection}>
            ...
            <div className={styles.inputContainer}>
              ...
              <div className={styles.toolbar}>
                <button className={styles.toolbarIcon} title="Thêm ảnh">
                  <svg viewBox="0 0 24 24">
                    <path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z" />
                  </svg>
                </button>
                <button className={styles.toolbarIcon} title="Thêm GIF">
                  <svg viewBox="0 0 24 24">
                ...
                <button className={styles.toolbarIcon} title="Thêm emoji">
                  <svg viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z" />
                  </svg>
                </button>
                <button className={styles.toolbarIcon} title="Thêm danh sách">
                  <svg viewBox="0 0 24 24">
                    <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z" />
                  </svg>
                </button>
                <button className={styles.toolbarIcon} title="Thêm vị trí">
                  <svg viewBox="0 0 24 24">
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.footerActions}>
            <button
              className={`${styles.postBtn} ${content.trim() ? styles.active : ''}`}
